...
CREATE TABLE `units` (
  ...
  `floor` varchar(50) DEFAULT NULL COMMENT 'SELECT option_id, title FROM list_options WHERE list_id = ''unit_floor'';',
  `obs` text DEFAULT NULL,
  `active` tinyint(1) DEFAULT NULL COMMENT '1-> Active, 0->Inactive',
  `operation` varchar(15) DEFAULT NULL COMMENT 'Add, Edit or Delete',
  `user_modif` varchar(255) DEFAULT NULL,
...
CREATE TABLE `prescriptions_schedule` (
  ...
  `patient_id` int(11) NOT NULL,
  `intravenous` tinyint(4) DEFAULT NULL COMMENT '1=Yes, 0=No',
  `scheduled` tinyint(4) DEFAULT NULL COMMENT '1=Yes, 0=No',
  `notifications` tinyint(4) DEFAULT NULL COMMENT '1=Yes, 0=No',
  `start_date` datetime DEFAULT NULL,
  `end_date` datetime DEFAULT NULL,
  `unit_frequency` int(11) DEFAULT NULL,
  `time_frequency` varchar(15) DEFAULT NULL,
  `unit_duration` int(11) DEFAULT NULL,
  `time_duration` varchar(25) DEFAULT NULL,
  `alarm1_unit` int(11) DEFAULT NULL,
  `alarm1_time` varchar(15) DEFAULT NULL,
  `alarm2_unit` int(11) DEFAULT NULL,
  `alarm2_time` varchar(15) DEFAULT NULL,
...
CREATE TABLE `prescriptions_supply` (
  ...
  `supply_notes` text DEFAULT NULL,
  `alarm1_datetime` datetime DEFAULT NULL,
  `alarm1_active` tinyint(4) DEFAULT 0,
  `alarm2_datetime` datetime DEFAULT NULL,
  `alarm2_active` tinyint(4) DEFAULT 0,
  `status` varchar(20) DEFAULT 'Pending' COMMENT 'Pending, Confirmed, Cancelled, Suspended, Modified',
  `confirmation_datetime` datetime DEFAULT NULL,
  `modification_datetime` datetime DEFAULT NULL,
  `active` tinyint(4) DEFAULT NULL,
  `effectiveness_score` varchar(50) DEFAULT NULL COMMENT 'SELECT title FROM list_options WHERE list_id=''drug_effectiveness'';',
  `effectiveness_notes` text DEFAULT NULL,
  `reaction_description` varchar(50) DEFAULT NULL,
  `reaction_time` datetime DEFAULT NULL,
  `reaction_notes` text DEFAULT NULL,
  `reaction_severity` varchar(50) DEFAULT NULL COMMENT 'SELECT title FROM list_options WHERE list_id=''severity_ccda'';',
...
CREATE TABLE `prescriptions_intravenous` (
  ...
  `vehicle` varchar(100) DEFAULT NULL COMMENT 'SELECT option_id, title FROM list_options WHERE list_id=''intravenous_vehicle'';',
  `catheter_type` varchar(100) DEFAULT NULL COMMENT 'SELECT option_id, title FROM list_options WHERE list_id=''catheter_type'';',
  `infusion_rate` decimal(5,2) DEFAULT NULL,
  `iv_route` varchar(100) DEFAULT NULL COMMENT 'SELECT option_id, title FROM list_options WHERE list_id=''intravenous_route'';',
